...
namespace GenericScreenGenFactoryLib
{
    ...
    public sealed class CGenericScreenGenFactory : IGenericScreenGenFactory
    {
        ...
        /// <inheritdoc />
        public bool TryCreateScreenConfigProvider(out IScreenConfigProvider? itfScreenConfigProvider, out string strError)
        {
            ...
            CScreenConfigProvider objScreenConfigProvider = new CScreenConfigProvider();
