...
namespace GenericScreenGenFactoryLib
{
    ...
    public interface IGenericScreenGenFactory : ICanInit
    {
        ...
        bool TryCreateScreenConfigProvider(ILayoutPolicyRegistry itfLayoutPolicyRegistry, out IScreenConfigProvider? itfScreenConfigProvider, out string strError);
