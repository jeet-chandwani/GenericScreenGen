...
**Req 4.2** Screen level changes as follows:
    ...
    **Req 4.2.4**. For a given section, the fields aray should have atleast 1 field. This will help us to ensure that the user fills in at least one field in the section before saving the data. These attributes arer also mandaotry for each section --> name, layout-policy and is-collapsible.
